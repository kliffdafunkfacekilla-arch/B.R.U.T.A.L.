# -*- coding: utf-8 -*-
"""Media Director Logic

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1FEyaGBrrYFGtSxxKzNNYlbpEQy9CBmh6
"""
...
if __name__ == "__main__":
    ...
    # Mock State from the Game Loop
    current_state = SceneState(
        location_tags=["crypt", "ancient"],
        tension_level=4, # High tension!
        current_weather="foggy",
        time_of_day="night"
    )

    narrative = "The Skeleton King screams as your fireball explodes against his shield!"

    print("--- AUDIO CUES ---")
    audio = director.analyze_scene_audio(narrative, current_state)
    for cue in audio:
        print(f"[{cue.type.upper()}] {cue.action} -> {cue.resource_id}")

    print("\n--- VISUAL PROMPT ---")
    visual = director.construct_image_prompt("The Skeleton King raising his sword", current_state)
    print(f"Generated Prompt: {visual.prompt}")